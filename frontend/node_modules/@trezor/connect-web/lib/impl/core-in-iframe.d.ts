...
import { CallMethodPayload, UiResponseEvent } from '@trezor/connect/src/events';
import { ConnectFactoryDependencies } from '@trezor/connect/src/factory';
import type { ConnectSettings, ConnectSettingsWeb, DeviceIdentity, Manifest } from '@trezor/connect/src/types';
...
export declare class CoreInIframe implements ConnectFactoryDependencies<ConnectSettingsWeb> {
    ...
    setTransports(): void;
    call(params: CallMethodPayload): Promise<import("@trezor/connect/src/types").Unsuccessful | {
        id: number;
        success: boolean;
        payload: any;
...
export declare const TrezorConnect: Omit<import("@trezor/connect/src/types").TrezorConnect, "init"> & {
    init: import("@trezor/connect/src/types/api/init").InitType<ConnectSettingsWeb>;
    call: import("@trezor/connect/src/events").CallMethod;
} & {
    renderWebUSBButton: (className?: string) => void;
    disableWebUSB: () => void;
    requestWebUSBDevice: () => Promise<void>;
