...
export declare const parseTransactionHexes: (network?: Network) => (hexes: string[]) => (import("@trezor/utxo-lib/src/transaction/base").TransactionBase<undefined> | import("@trezor/utxo-lib/src/transaction/base").TransactionBase<import("@trezor/utxo-lib/src/transaction/dash").DashSpecific> | import("@trezor/utxo-lib/src/transaction/base").TransactionBase<import("@trezor/utxo-lib/src/transaction/zcash").ZcashSpecific>)[];
