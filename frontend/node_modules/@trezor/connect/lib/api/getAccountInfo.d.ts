...
export default class GetAccountInfo extends AbstractMethod<'getAccountInfo', Request[]> {
    ...
    run(): Promise<AccountInfo | (AccountInfo | null)[] | {
        ...
        empty: boolean;
        tokens?: import("@trezor/blockchain-link-types/src/common").TokenInfo[];
        addresses?: import("@trezor/blockchain-link-types/src/common").AccountAddresses;
        history: {
            total: number;
            tokens?: number;
            unconfirmed: number;
            transactions?: import("@trezor/blockchain-link-types/src/common").Transaction[];
            txids?: string[];
            addrTxCount?: number;
        };
        misc?: {
            nonce?: string;
            contractInfo?: import("@trezor/blockchain-link-types/src/blockbook-api").ContractInfo;
            stakingPools?: import("@trezor/blockchain-link-types/src/blockbook-api").StakingPool[];
            addressAliases?: {
                [key: string]: import("@trezor/blockchain-link-types/src/blockbook-api").AddressAlias;
            };
            sequence?: number;
            ...
            owner?: string;
            rent?: number;
            solStakingAccounts?: import("@trezor/blockchain-link-types/src/solana").SolanaStakingAccount[];
            solEpoch?: number;
        };
        page?: {
            index: number;
