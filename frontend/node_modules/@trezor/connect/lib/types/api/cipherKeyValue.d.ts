...
export declare const CipherKeyValue: import("@trezor/schema-utils").TObject<{
    ...
    value: import("@trezor/schema-utils").TUnion<[import("@trezor/schema-utils").TString, import("@trezor/schema-utils/src/custom-types/buffer").TBuffer]>;
    ...
    iv: import("@trezor/schema-utils").TOptional<import("@trezor/schema-utils").TUnion<[import("@trezor/schema-utils").TString, import("@trezor/schema-utils/src/custom-types/buffer").TBuffer]>>;
}>;
