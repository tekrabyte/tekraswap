...
export declare const ApplySettings: import("@trezor/schema-utils").TObject<{
    ...
    safety_checks: import("@trezor/schema-utils").TOptional<import("@trezor/schema-utils/src/custom-types/keyof-enum").TKeyOfEnum<typeof PROTO.Enum_SafetyCheckLevel>>;
    auto_lock_delay_ms: import("@trezor/schema-utils").TOptional<import("@trezor/schema-utils").TNumber>;
    display_rotation: import("@trezor/schema-utils").TOptional<import("@trezor/schema-utils").TUnion<[import("@trezor/schema-utils/src/custom-types/keyof-enum").TKeyOfEnum<typeof PROTO.Enum_DisplayRotation>, import("@trezor/schema-utils").TEnum<typeof PROTO.Enum_DisplayRotation>]>>;
